...
export function EmptyState({
    ...
    const buttonClasses = "group relative overflow-hidden px-6 py-3 md:px-8 md:py-3 bg-black text-white dark:bg-white dark:text-black font-mono text-xs font-bold uppercase tracking-[0.2em] transition-all hover:bg-gold hover:text-black dark:hover:bg-gold dark:hover:text-black active:scale-95 border-2 border-black dark:border-white";

    return (
        <div className={`relative p-8 md:p-12 lg:p-20 flex flex-col items-center justify-center text-center overflow-hidden border-2 border-dashed border-black/10 dark:border-white/10 bg-gray-50/50 dark:bg-white/[0.02] ${className}`}>
            ...
            <div className="relative z-10 max-w-xl space-y-6">
                <h3 className="text-2xl md:text-4xl font-black uppercase tracking-tight leading-none text-black dark:text-white">
                    {message}
                </h3>

                <p className="font-mono text-[10px] md:text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest">
